...
namespace TruckMove.API.DAL.Migrations
{
    ...
    [Migration("20250325090357_isfromQA_PayemntAdjustments")]
    partial class isfromQA_PayemntAdjustments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TruckMove.API.DAL.Models.Delay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TruckMove.API.DAL.Models.PaymentAdjustment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TruckMove.API.DAL.Models.PublicTransport", b =>
                {
                    ...
                    b.Property<string>("RequiredFromsuburb")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RequiredTosuburb")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TruckMove.API.DAL.Models.Rates", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Description = "Rate paid per km for standard jobs",
                            Name = "Per_KM_Rate",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 2,
                            Description = "Maximum amount of KMs for a fixed cost job",
                            Name = "Max_fixed_job_KMs",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 3,
                            Description = "Standard fixed cost rate (4 hours at grade 4 rate)",
                            Name = "Fixed_job_rate",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 4,
                            Description = "Additional amount per KM paid when towing a commercial load",
                            Name = "Commercial_load_KM_rate",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 5,
                            Description = "Hourly rate paid in the event of a delay",
                            Name = "Delay_hourly_rate",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 6,
                            Description = "Per KM rate paid when towing dangerous goods",
                            Name = "Dangerous_Goods_day_Rate",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 7,
                            Description = "Hourly rate paid when traveling on public transport",
                            Name = "Public_transport_hourly_Rate",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 8,
                            Description = "Rate paid per km when working on a public holiday",
                            Name = "Public_holiday_KM_rate",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 9,
                            Description = "Rate paid per km when working on a Saturday",
                            Name = "Saturday_KM_rate",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 10,
                            Description = "Rate paid per km when working on a Sunday",
                            Name = "Sunday_KM_rate",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 11,
                            Description = "Public holiday fixed cost rate",
                            Name = "Public_holiday_fixed_rate",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 12,
                            Description = "Saturday fixed cost rate",
                            Name = "Saturday_fixed_rate",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 13,
                            Description = "Sunday fixed cost rate",
                            Name = "Sunday_fixed_rate",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 14,
                            Description = "Rate paid for a Single Hookup",
                            Name = "Hookup_Single",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 15,
                            Description = "Rate paid for a Double Hookup",
                            Name = "Hookup_Double",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 16,
                            Description = "Rate paid for a 4RA Hookup",
                            Name = "Hookup_4RA",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 17,
                            Description = "Anything under 500km",
                            Name = "Grade_4_Hourly_rate",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 18,
                            Description = "",
                            Name = "Grade_1_Hourly_rate_riding_on_public_transport",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 19,
                            Description = "",
                            Name = "Hookup_Road_Train",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 20,
                            Description = "If between 350 and 500 it becomes a 500 job",
                            Name = "Saturday_Hour_rate",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 21,
                            Description = "When under 350, then goes to hourly, minimum 4 hours",
                            Name = "Sunday_Hour_rate",
                            Value = 0.0
                        },
                        new
                        {
                            Id = 22,
                            Description = "Hookup = driving with a trailer",
                            Name = "Holiday_hour_rate",
                            Value = 0.0
                        },
                        new
                        {
            ...
            modelBuilder.Entity("TruckMove.API.DAL.Models.Trailer", b =>
                {
                    ...
                    b.Property<string>("DropoffCoordinate")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TruckMove.API.DAL.Models.TrailerStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("TrailerStatus", (string)null);
            ...
            modelBuilder.Entity("TruckMove.API.DAL.Models.DelayDriver", b =>
                {
                    b.HasOne("TruckMove.API.DAL.Models.Delay", "Delay")
                        .WithMany("DelayDrivers")
                        .HasForeignKey("DelayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_DelayDrivers_Delays");

                    b.HasOne("TruckMove.API.DAL.Models.User", "Driver")
                        .WithMany("DelayDrivers")
                        .HasForeignKey("DriverId")
                        .IsRequired()
                        .HasConstraintName("FK_DelayDrivers_Users");

                    b.HasOne("TruckMove.API.DAL.Models.PaymentStatus", "PaymentStatusNavigation")
                        .WithMany("DelayDrivers")
            ...
            modelBuilder.Entity("TruckMove.API.DAL.Models.PaymentAdjustment", b =>
                {
                    b.HasOne("TruckMove.API.DAL.Models.User", "CreatedBy")
                        .WithMany("PaymentAdjustmentCreatedBies")
                        .HasForeignKey("CreatedById");

                    b.HasOne("TruckMove.API.DAL.Models.User", "Driver")
                        .WithMany("PaymentAdjustments")
                        .HasForeignKey("DriverId")
                        .IsRequired()
                    ...
                    b.HasOne("TruckMove.API.DAL.Models.PaymentStatus", "StatusNavigation")
                        .WithMany("PaymentAdjustments")
                        .HasForeignKey("Status")
                        .IsRequired()
                    ...
                    b.HasOne("TruckMove.API.DAL.Models.User", "UpdatedBy")
                        .WithMany("PaymentAdjustmentUpdatedBies")
                        .HasForeignKey("UpdatedById");
            ...
            modelBuilder.Entity("TruckMove.API.DAL.Models.Trailer", b =>
                {
                    ...
                    b.HasOne("TruckMove.API.DAL.Models.TrailerStatus", "StatusNavigation")
                        .WithMany("Trailers")
                        .HasForeignKey("Status")
            ...
            modelBuilder.Entity("TruckMove.API.DAL.Models.Job", b =>
                {
                    ...
                    b.Navigation("PaymentAdjustments");
            ...
            modelBuilder.Entity("TruckMove.API.DAL.Models.User", b =>
                {
                    ...
                    b.Navigation("LegCreatedBies");

                    b.Navigation("LegUpdatedBies");

                    b.Navigation("Legs");

                    b.Navigation("PaymentAdjustmentCreatedBies");

                    b.Navigation("PaymentAdjustmentUpdatedBies");
